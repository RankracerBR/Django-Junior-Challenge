...
def _ipy_display_hook(
    ...
    from .console import \
        ConsoleRenderable  # needed here to prevent circular import
...
def traverse(
    ...
    def _traverse(obj: Any, root: bool = False, depth: int = 0) -> Node:
        ...
        def iter_rich_args(rich_args: Any) -> Iterable[Any | tuple[str, Any]]:
        ...
        rich_repr_result: RichReprResult | None = None
            ...
            if attr_fields:
                if reached_max_depth:
                    ...
                    def iter_attrs() -> Iterable[
                        tuple[str, Any, Callable[[Any], str] | None]
                    ]:
