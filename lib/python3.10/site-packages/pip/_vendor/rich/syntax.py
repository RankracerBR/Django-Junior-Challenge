...
class Syntax(JupyterMixin):
    ...
    def from_path(
        ...
        """
        with open(path, encoding=encoding) as code_file:
            code = code_file.read()
    ...
    def highlight(self, code: str, line_range: tuple[int, int] | None = None) -> Text:
        ...
        if lexer is None:
            ...
            if line_range:
                ...
                def tokens_to_spans() -> Iterable[tuple[str, Style | None]]:
