...
from typing import (IO, TYPE_CHECKING, Any, Dict, List, Literal, NamedTuple,
                    Optional, Protocol, TextIO, Tuple, Type, Union, cast,
                    runtime_checkable)
...
class ScreenContext:
    ...
    def update(
        self, *renderables: RenderableType, style: StyleType | None = None
    ) -> None:
        """Update the screen.
...
class Console:
    ...
    def __init__(
        ...
        *,
        color_system: None
        | (Literal["auto", "standard", "256", "truecolor", "windows"]) = "auto",
    ...
    def is_terminal(self) -> bool:
        ...
        isatty: Callable[[], bool] | None = getattr(self.file, "isatty", None)
        try:
    ...
    def screen(
        self, hide_cursor: bool = True, style: StyleType | None = None
    ) -> "ScreenContext":
    ...
    def get_style(
        self, name: str | Style, *, default: Style | str | None = None
    ) -> Style:
