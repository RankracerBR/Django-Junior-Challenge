...
def auto(cls: T | None = None, *, angular: bool | None = None) -> T | Callable[[T], T]:
    """Class decorator to create __repr__ from __rich_repr__"""

    def do_replace(cls: type[T], angular: bool | None = None) -> type[T]:
...
def rich_repr(cls: T | None = None, *, angular: bool = False) -> T | Callable[[T], T]:
    if cls is None:
