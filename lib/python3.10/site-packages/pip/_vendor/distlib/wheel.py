...
class Wheel:
    ...
    def metadata(self):
        ...
        name_ver = "{}-{}".format(self.name, self.version)
    ...
    def build(self, paths, tags=None, wheel_version=None):
        ...
        for pyver, abi, arch in self.tags:
            wheel_metadata.append("Tag: {}-{}-{}".format(pyver, abi, arch))
    ...
    def update(self, modifier, dest_dir=None, **kwargs):
        ...
        def get_version(path_map, info_dir):
            version = path = None
            key = "{}/{}".format(info_dir, LEGACY_METADATA_FILENAME)
        ...
        if m:
            ...
            while minor >= 0:
                for match in matches:
                    s = "{}_{}_{}_{}".format(name, major, minor, match)
                ...
                if len(parts) == 2:
                    ...
                    result.append(
                        (
                            "".join((IMP_PREFIX, versions[0])),
                            abi,
                            "manylinux_{}_{}_{}".format(parts[0], parts[1], arch),
                        )
                    )
