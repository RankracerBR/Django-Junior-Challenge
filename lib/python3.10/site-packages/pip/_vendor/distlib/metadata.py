...
class LegacyMetadata:
        ...
        for fields, controller in (
            ...
            for field in fields:
                ...
                if value is not None and not controller(value):
                    warnings.append("Wrong value for '{}': {}".format(field, value))
    ...
    def __repr__(self):
        return "<{} {} {}>".format(self.__class__.__name__, self.name, self.version)
...
class Metadata:
    ...
    def __repr__(self):
        ...
        return "<{} {} {} ({})>".format(
            self.__class__.__name__, self.metadata_version, name, version
        )
