...
from typing import Dict, Generic, List, NamedTuple, Optional, Set, TypeVar
...
class ElementState:
    ...
    def __init__(
        ...
        self.parent_index: int | None = parent_index
...
class ConverterState:
    ...
    def __init__(self, diagram_kwargs: dict | None = None):
...
def _apply_diagram_item_enhancements(fn):
    ...
    def _inner(
        element: pyparsing.ParserElement,
        parent: EditablePartial | None,
        lookup: ConverterState = None,
        vertical: int = None,
        index: int = 0,
        name_hint: str = None,
        show_results_names: bool = False,
    ) -> EditablePartial | None:
