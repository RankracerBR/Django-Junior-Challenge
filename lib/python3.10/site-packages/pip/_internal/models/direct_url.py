...
class VcsInfo:
    ...
    @classmethod
    def _from_dict(cls, d: dict[str, Any] | None) -> Optional["VcsInfo"]:
        if d is None:
            return None
        return cls(
...
class ArchiveInfo:
    ...
    @classmethod
    def _from_dict(cls, d: dict[str, Any] | None) -> Optional["ArchiveInfo"]:
        if d is None:
            return None
...
class DirInfo:
    ...
    @classmethod
    def _from_dict(cls, d: dict[str, Any] | None) -> Optional["DirInfo"]:
        if d is None:
            return None
