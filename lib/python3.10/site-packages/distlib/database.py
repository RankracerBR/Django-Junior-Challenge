...
class DistributionPath:
    ...
    def provides_distribution(self, name, version=None):
        ...
        if version is not None:
            try:
                matcher = self._scheme.matcher("{} ({})".format(name, version))
            except ValueError:
                raise DistlibException(
                    "invalid name or version: {!r}, {!r}".format(name, version)
                )
...
class Distribution:
    ...
    def __repr__(self):
        ...
        if self.source_url:
            ...
            suffix = ""
        return "<Distribution {} ({}){}>".format(self.name, self.version, suffix)
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    def __init__(self, path, metadata=None, env=None):
        ...
        if env and env._cache_enabled and path in env._cache.path:
            ...
            if r is None:
                raise ValueError("no {} found in {}".format(METADATA_FILENAME, path))
            ...
            *data*: the contents of a setuptools-produced requires.txt file.
            ...
            for line in lines:
                ...
                if not r.constraints:
                    ...
                    reqs.append("{} ({})".format(r.name, cons))
            return reqs
...
class DependencyGraph:
    ...
    def topological_sort(self):
        ...
        while True:
            ...
            logger.debug(
                "Moving to result: %s",
                ["{} ({})".format(d.name, d.version) for d in to_remove],
            )
